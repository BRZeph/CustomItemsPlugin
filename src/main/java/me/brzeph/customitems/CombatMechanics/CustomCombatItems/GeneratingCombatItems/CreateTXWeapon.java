...
import static me.brzeph.customitems.CombatMechanics.CustomCombatItems.GeneratingCombatItems.GeneratingWeaponOrb.orbWeapon;
...
public class CreateTXWeapon {
    public static ItemStack createTXWeaponAxe(int tier){
        ...
        nbtItem.setBoolean("doubleElemental", false);
    ...
    public static ItemStack createTXWeaponShovel(int tier){
        ...
        nbtItem.setBoolean("doubleElemental", true);
        nbtItem.setInteger("minDamage", minDamage);
        nbtItem.setInteger("maxDamage", maxDamage);
        ItemStack itemStack = new ItemStack(nbtItem.getItem());
        ItemMeta itemMeta = itemStack.getItemMeta();
    ...
    public static ItemStack createTXWeaponRandomType(int tier){
        ...
        Material material = nbtItem.getItem().getType();
        if (material.equals(Material.WOODEN_SHOVEL) || material.equals(Material.STONE_SHOVEL) ||material.equals(Material.IRON_SHOVEL) ||
                material.equals(Material.DIAMOND_SHOVEL) ||material.equals(Material.GOLDEN_SHOVEL)){
            nbtItem.setBoolean("doubleElemental", true);
        } else {
            nbtItem.setBoolean("doubleElemental", false);
        }
