...
public class CreateCombatItemsCommands implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label, @NotNull String[] args) {
        ...
        if (cmd.getName().equalsIgnoreCase("t1armor")){
            ...
            player.getInventory().addItem(upgradingArmorLore(CreateTXArmor.createTXLeggings(1)));
            player.getInventory().addItem(upgradingArmorLore(CreateTXArmor.createTXBoots(1)));
            player.getInventory().addItem(CreateTXWeapon.createTXWeaponRandomType(1));
        }
        if (cmd.getName().equalsIgnoreCase("t2armor")){
            player.getInventory().addItem(upgradingArmorLore(CreateTXArmor.createTXHelmet(2)));
            player.getInventory().addItem(upgradingArmorLore(CreateTXArmor.createTXChestPlate(2)));
            player.getInventory().addItem(upgradingArmorLore(CreateTXArmor.createTXLeggings(2)));
            player.getInventory().addItem(upgradingArmorLore(CreateTXArmor.createTXBoots(2)));
            player.getInventory().addItem(CreateTXWeapon.createTXWeaponRandomType(2));
        }
        if (cmd.getName().equalsIgnoreCase("t3armor")){
            player.getInventory().addItem(upgradingArmorLore(CreateTXArmor.createTXHelmet(3)));
            player.getInventory().addItem(upgradingArmorLore(CreateTXArmor.createTXChestPlate(3)));
            player.getInventory().addItem(upgradingArmorLore(CreateTXArmor.createTXLeggings(3)));
            player.getInventory().addItem(upgradingArmorLore(CreateTXArmor.createTXBoots(3)));
            player.getInventory().addItem(CreateTXWeapon.createTXWeaponRandomType(3));
        }
        if (cmd.getName().equalsIgnoreCase("t4armor")){
            player.getInventory().addItem(upgradingArmorLore(CreateTXArmor.createTXHelmet(4)));
            player.getInventory().addItem(upgradingArmorLore(CreateTXArmor.createTXChestPlate(4)));
            player.getInventory().addItem(upgradingArmorLore(CreateTXArmor.createTXLeggings(4)));
            player.getInventory().addItem(upgradingArmorLore(CreateTXArmor.createTXBoots(4)));
            player.getInventory().addItem(CreateTXWeapon.createTXWeaponRandomType(4));
        }
        if (cmd.getName().equalsIgnoreCase("t5armor")){
            player.getInventory().addItem(upgradingArmorLore(CreateTXArmor.createTXHelmet(5)));
            player.getInventory().addItem(upgradingArmorLore(CreateTXArmor.createTXChestPlate(5)));
            player.getInventory().addItem(upgradingArmorLore(CreateTXArmor.createTXLeggings(5)));
            player.getInventory().addItem(upgradingArmorLore(CreateTXArmor.createTXBoots(5)));
